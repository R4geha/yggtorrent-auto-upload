...
def language_field_serie(driver, new_title_without_format):
    try:
        ...
        if "VFF." in new_title_without_format or "FRENCH." in new_title_without_format or "VFi." in new_title_without_format or "VFI." in new_title_without_format or "VFF2." in new_title_without_format:
